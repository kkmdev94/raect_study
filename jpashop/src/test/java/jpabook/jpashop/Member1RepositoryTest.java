...
class Member1RepositoryTest {
    ...
    @Autowired
    MemberRepository_1 memberRepository1;

    @Test
    @Transactional
    public void testMember() {
        //given
        Member_1 member1 = new Member_1();
        member1.setUsername("memberA");

        //when
        Long saveId = memberRepository1.save(member1);
        Member_1 findMember1 = memberRepository1.find(saveId);

        //then
        assertThat(findMember1.getId()).isEqualTo(member1.getId());
        assertThat(findMember1.getUsername()).isEqualTo("memberA");
        ...
        System.out.println("findMember == member : " + (findMember1 == member1));
    }
}