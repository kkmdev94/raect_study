...
public class LocalDateTimeMain {
    ...
    public static void main(String[] args) {
        ...
        //계산(불변)
        ofDt = ofDt.plusDays(3);
        System.out.println("지정 날짜 + 시간 + 3D = " + ofDt);
        LocalDateTime ofYear = ofDt.plusYears(3000);
        ...
        System.out.println("현재 날짜시간이 지정 날짜시간보다 같은가? " + nowDt.equals(ofDt));
    }
}
