...
public class MyHashSetV2 {
    ...
    private LinkedList<Object>[] buckets; // 아무거나 다 받을 수 있다. 세상 모든것을 담을 수 있는 Object이기 떄문에.

    private int size = 0;
    private int capacity = DEFAULT_INITIAL_CAPACITY;

    public MyHashSetV2() { // 기본생성 Default Capacity 16개 기반의 배열이 만들어짐
        initBuckets();
    }

    public MyHashSetV2(int capacity) { // capacity를 매개변수로 받아서 capacity를 내가 셋팅하는 생성자
